...
function deepNoteDetail(): DeepNoteRunDetail {
  return {
    ...
    budget: {
      ...
      semanticCallsUsed: 2,
      upstreamRequestLimit: 640,
      upstreamRequestsUsed: 3,
      nodeAttemptLimit: 5,
    ...
    contextBudget: {
      ...
      adaptiveChunkLimitTokens: 16_000,
      adaptiveRouteKey: "route-1",
      adaptiveRouteState: "available",
      adaptiveProfileSamples: 12,
      chunkCount: 1,
